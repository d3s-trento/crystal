...
#define CRYSTAL_CONF_DUR_S ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_DUR_S_MS/1000)
#endif
...
#define CRYSTAL_CONF_DUR_T ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_DUR_T_MS/1000)
#endif
...
#define CRYSTAL_CONF_DUR_A ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_DUR_A_MS/1000)
#endif
...
#ifdef CRYSTAL_CONF_MAX_DATA_LEN
