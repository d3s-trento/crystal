...
#define CRYSTAL_CONF_PERIOD ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_PERIOD_MS/1000)
#endif

#ifndef CRYSTAL_CONF_PERIOD
#define CRYSTAL_CONF_PERIOD RTIMER_SECOND
#endif
...
#define ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_DUR_S_MS/1000)
#endif
...
#define ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_DUR_T_MS/1000)
#endif
...
#define ((uint32_t)RTIMER_SECOND*CRYSTAL_CONF_DUR_A_MS/1000)
#endif
...
#else
#define CRYSTAL_LOGLEVEL CRYSTAL_NO_LOGS
#endif
...
#else
#define CRYSTAL_CHHOP_MAPPING CHMAP_nomap
#endif

#ifdef CRYSTAL_CONF_BSTRAP_CHHOPING
#define CRYSTAL_BSTRAP_CHHOPPING CRYSTAL_CONF_BSTRAP_CHHOPING
#else
